...
groupRouter.route('/<name>', endpoint='group_delete', methods=['DELETE'])(group_delete.group_delete_ctrl)
groupRouter.route('/<name>', endpoint='group_update', methods=['PUT'])(group_update.group_update_ctrl)
